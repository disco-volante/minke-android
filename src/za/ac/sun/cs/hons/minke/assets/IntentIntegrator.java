 ...
 * 
 * 
 * (scanResult != null) // handle scan result } // else continue with any other
...
public final class IntentIntegrator {
	 ...
	 * </p>
	 * 
	 * @return null if the event handled here was not related to
	 *         {@link IntentIntegrator}, or else an {@link IntentResult}
	 *         containing the result of the scan. If the user cancelled
	...
	public static void shareText(Activity activity, CharSequence text,
			...
			int stringButtonNo) {
		shareText(activity, text, activity.getString(stringTitle),
